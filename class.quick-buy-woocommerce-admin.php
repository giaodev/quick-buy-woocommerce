...
class quick_buy_admin{
	...
	public static function setup_setting(){
		$instance = self::get_instance();
		add_settings_section( 'quick_buy_section', 'Setting Quick Buy Woocommerce', array($instance, 'display_quick_buy_section'), 'setting_giaovn');
		add_settings_field( 'quick_buy_name', __('Name Button'), array($instance,'display_quick_buy_field'), 'setting_giaovn', 'quick_buy_section');
		add_settings_field( 'quick_buy_class', 'Class CSS', array($instance, 'display_quick_buy_class_css'), 'setting_giaovn', 'quick_buy_section');
		add_settings_field( 'quick_buy_type', __('Styles'), array($instance, 'display_quick_buy_type'), 'setting_giaovn', $section = 'quick_buy_section');
		add_settings_field( 'quick_buy_show_button', __('Show Button'), array($instance, 'display_quick_buy_show_button'), 'setting_giaovn', $section = 'quick_buy_section');
	...
	public static function display_quick_buy_type( $args ){
		...
		echo '> Advanced</label></p>';
	}
	public static function display_quick_buy_field( $args ){
		echo '<input name="_quick_buy[quick_buy_name]" type="text" id="_quick_buy[quick_buy_name]" value="'.self::$option['quick_buy_name'].'" class="regular-text" placerholder="Quick Buy">';
	}
	...
	public static function display_quick_buy_show_button($args){
		echo '<label for="rich_editing"><input name="rich_editing" type="checkbox" id="rich_editing" value="false"> Don\'t override buy now button</label>';
	}
