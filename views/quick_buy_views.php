  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <form action="" method="post">
        <label for="">Tên</label>
        <input type="text" class="input-text " name="name" id="name" placeholder="Tên" value="">
        <br>
        <label for="">Địa chỉ</label>
        <input type="text" class="input-text " name="address" id="address" placeholder="Địa chỉ" value="" placeholder="Địa chỉ">
        <br>
        <label for="">Số điện thoại</label>
        <input type="tel" class="input-text " name="phone" id="phone" placeholder="Số điện thoại" value="">
        <br>
